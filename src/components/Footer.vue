<template>
  <footer class="text-black py-12" style="background-color: rgba(210, 185, 167, 0.25);">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p class="text-gray-400">
            Non-profit organization dedicated to rescuing, rehabilitating, and finding homes for abandoned animals.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            ...
            <li>+40 074 306 122</li>
          </ul>
        </div>
        
        <!-- Social -->
        <div>
          <h3 class="text-xl  mb-4">Social Media</h3>
