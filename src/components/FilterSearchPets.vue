<template>
        ...
        <div v-if="showFilters" class="px-6 py-5 border-t border-gray-100 bg-gray-50">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <select v-model="filters.species" @change="updateFilters" class="enhanced-filter-input">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <select v-model="filters.sex" @change="updateFilters" class="enhanced-filter-input">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <select v-model="filters.size" @change="updateFilters" class="enhanced-filter-input">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <select v-model="filters.healthStatus" @change="updateFilters" class="enhanced-filter-input">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <select v-model="filters.status" @change="updateFilters" class="enhanced-filter-input">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <select v-model="filters.county" @change="handleCountyChange" class="enhanced-filter-input">
  ...
  export default {
    ...
    emits: ['update:filters', 'update:sortBy', 'county-change', 'reset-filters'],
    setup(props, { emit }) {
      ...
      const initializeFilters = () => {
        Object.keys(props.filtersFromParent).forEach(key => {
          if (key in filters) {
            filters[key] = props.filtersFromParent[key];
          }
        });
        sortByValue.value = props.sortByFromParent;
      };
      ...
      watch(() => props.filtersFromParent, (newValue) => {
        Object.keys(newValue).forEach(key => {
          if (key in filters && filters[key] !== newValue[key]) {
            filters[key] = newValue[key];
          }
        });
      }, { deep: true });
  

      watch(() => props.sortByFromParent, (newValue) => {
        if (sortByValue.value !== newValue) {
      ...
      const formatFilterValue = (key, value) => {
        ...
        if (key === 'county' && props.countyCodeToName[value]) {
          return props.countyCodeToName[value];
        }
        return value;
      };
