<template>
    <AlertDialog :open="isOpen" @update:open="$emit('update:isOpen', $event)">
      <AlertDialogContent class="bg-white rounded-2xl shadow-lg sm:max-w-md">
        <AlertDialogHeader>
        ...
        <AlertDialogFooter class="mt-6 flex gap-3">
          <AlertDialogCancel 
            class="flex-1 px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-2xl hover:bg-gray-50 transition-colors"
            @click="handleCancel"
          >
            {{ cancelButtonText }}
          </AlertDialogCancel>
          ...
          <AlertDialogAction 
            class="flex-1 px-4 py-2 bg-red-600 text-white rounded-2xl hover:bg-red-700 transition-colors"
            @click="handleConfirm"
          >
            {{ confirmButtonText }}
          </AlertDialogAction>
